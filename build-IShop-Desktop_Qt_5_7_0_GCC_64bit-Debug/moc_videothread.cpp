...
QT_MOC_LITERAL(1, 12, 10), // "recv_image"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5) // "char*"

    },
    "VideoThread\0recv_image\0\0char*"
};
...
void VideoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recv_image((*reinterpret_cast< char*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (VideoThread::*_t)(char * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoThread::recv_image)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoThread::recv_image(char * _t1, int _t2)
{
